...
export default function LandingHeader() {
    return (
        <header className="w-full px-6 py-6 flex items-center justify-between z-50 max-w-7xl mx-auto relative">
            <TransitionLink href="/" className="flex items-center gap-1 cursor-pointer">
                <div className="w-5 h-5 bg-white rounded-full"></div>
                <div className="w-5 h-5 bg-white/70 rounded-full -ml-2"></div>
                <div className="w-5 h-5 bg-white/40 rounded-full -ml-2"></div>
            </TransitionLink>
            <nav className="hidden md:flex items-center gap-8 font-nav text-gray-400 dark:text-gray-300 absolute left-1/2 -translate-x-1/2">
                    ...
                    return (
                        ...
                        >
                            {(() => {
                                if (!connected) {
                                    return (
                                        <button onClick={openConnectModal} type="button" className="bg-white text-black px-6 py-3 rounded-xl font-bold text-xs tracking-wider hover:bg-gray-200 hover:scale-105 transition-all uppercase">
                                            Connect Wallet
                                        </button>
                                    );
                                }
