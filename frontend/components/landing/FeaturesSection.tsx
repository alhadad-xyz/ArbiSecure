    ...
    return (
        <section id="features" className="py-24 px-4 max-w-7xl mx-auto w-full">
            <div className="text-center mb-16">
                <h2 className="text-4xl font-header mb-4">Why ArbiSecure?</h2>
                <p className="text-xl text-gray-500 font-serif italic">The trustless layer for modern work.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {features.map((feature, index) => (
                    <div key={index} className="p-8 rounded-card bg-glass border border-glass-border hover:border-white/20 transition-all hover:-translate-y-1 hover:bg-glass-hover">
