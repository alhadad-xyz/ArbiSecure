    ...
    return (
        <section className="flex-grow flex flex-col items-center justify-center px-4 md:px-0 max-w-7xl mx-auto w-full">
            <div className="text-center mb-16 space-y-2 md:space-y-4">
                <h1 className="text-5xl md:text-8xl leading-tight tracking-tight">
                    <span className="font-header">ARBISECURE</span> <span
                        className="font-serif italic font-light text-gray-400">IS THE</span>
                    <br />
                    <span className="font-serif">TRUSTLESS</span> <span className="font-header">ESCROW</span>
                    <br />
                    <span className="font-header">FOR</span> <span
                        className="font-serif font-light text-gray-300">THE</span> <span
                            className="font-header">GLOBAL</span> <span className="font-serif">ECONOMY</span>
                </h1>
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-20">
                ...
                <button
                    className="flex items-center justify-between bg-primary text-black rounded-full pl-6 pr-2 py-2 hover:bg-gray-200 transition-all font-nav font-bold w-48 h-14">
